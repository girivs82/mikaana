---
title: "SKALP: An Intent-Preserving Hardware Description Language with Compile-Time Clock Domain Safety and GPU-Accelerated Fault Simulation"
date: 2026-02-23
summary: "Technical whitepaper describing SKALP's four-stage IR pipeline, compile-time clock domain safety through the type system, GPU-accelerated fault simulation on Apple Metal, and integrated ISO 26262 functional safety analysis."
tags: ["skalp", "whitepaper", "hardware", "hdl", "compiler", "safety"]
ShowToc: true
---

**Author:** Shankar Giri V

**Repository:** https://github.com/girivs82/skalp

**Website:** https://mikaana.com

**Also available as:** [PDF (LaTeX/IEEEtran)](/supporting-docs/skalp/skalp-whitepaper.pdf)
